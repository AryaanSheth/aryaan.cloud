    ...
    <div className="page">
      <aside className="toc" aria-label="Table of contents">
        ...
        <nav>
          <ul className="toc__list">
            ...
            <li><a href="#blog"><span className="num">04</span><span>Blog</span></a></li>
      ...
      <article className="main">
        ...
        <section className="section" id="blog">
              ...
              <ul className="blog-index">
                {posts.map(post => (
                  <li key={post.slug}>
                    ...
                    <span className="blog-index__date">{formatDate(post.date)}</span>
                  </li>
                ))}
              </ul>
            )}
          ...
          {posts.map(post => (
            <article key={post.slug} className="blog-post" id={`blog-${post.slug}`}>
